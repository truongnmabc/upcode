...
const AnswerSheet = () => {
  ...
  function onRender(
    ...
    // console.log("🚀 ~ AnswerSheet ~ baseDuration:", baseDuration);
    // console.log("🚀 ~ AnswerSheet ~ actualDuration:", actualDuration);
    // console.log("🚀 ~ AnswerSheet ~ startTime:", startTime);
    // console.log("🚀 ~ AnswerSheet ~ commitTime:", commitTime);
