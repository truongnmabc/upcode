    ...
    return (
        <div className="about-layout-container">
            <div className="background-about-page align-center">
                ...
                <p className="p2">
                    Our unwavering mission is to simplify the learning journey
                    for our users, providing them with the tools and resources
                    they need to pass their tests with ease. 
                </p>
            </div>
            <MyContainer className="about-page-content">
                ...
                <div className="part-1 flex">
                    <div className="subject-content">
                        <p className="p-title">
                            A Streamlined Path to Attain Desired Certificate
                        </p>
                        <div className="line-color" />
                        <p className="p-description">
                            Our platform offers users a carefully designed
                            pathway that not only facilitates the attainment of
                            their desired certificate but also ensures an
                            effective journey towards achieving their academic
                        ...
                        >
                            <div className="align-center">
                                View more <div className="shape-circle-1" />{" "}
                ...
                <div className="part-2 flex">
                    ...
                    <div className="subject-content">
                        <p className="p-title">
                            Dedicated Professionals Who Make a Difference
                        </p>
                        <div className="line-color" />
                        <p className="p-description">
                            We take pride in our exceptional team. Each member
                            is a distinguished subject matter expert in their
                            respective fields, equipped with a wealth of
                            knowledge and possessing extensive experience in
                            test preparation.
                        </p>
                    </div>
                </div>
                <div className="part-3 flex">
                    <div className="subject-content">
                        <p className="p-title">
                            A Trusted E-Learning Platform That Exceeds User
                            Expectations
                        </p>
                        <div className="line-color" />
                        <p className="p-description">
                            We are diligently working towards the establishment
                            of a reputable e-learning platform. Through
                            continuous improvement, we strive to create an
                            exceptional learning environment that consistently
                ...
                <div className="grid-features">
                    {featuresData.map((feature, index) => {
                        return (
                            <div
                                key={index}
                                className="align-center about-feature-item"
                            >
