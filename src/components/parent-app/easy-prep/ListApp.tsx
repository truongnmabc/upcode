            ...
            {/* <div className="category-and-list-app">
                <div className="category-container">
                    <div className="slider-left" id="slider-left">
                        <div
                            className="left-icon align-center"
                    ...
                    <nav
                        ref={navRef}
                        id="nav-category"
                        className="align-center category"
                    >
                        {categories.map((category, index) => {
                            return (
                                <div
                                    ...
                                    onClick={(e) => {
                                        ...
                                        if (
                                            ...
                                            action = "click_it_block";
                                        else if (
                                            category.name ===
                                            "HSE & College Admission"
                                        )
                                            action = "click_hse_block";
                                        else if (
                                            category.name ===
                                            "Medical & Nursing"
                                        )
                                            action = "click_med_block";
                                        else if (category.name === "Drivers Ed")
                                            action = "click_driver_block";
                                        else if (category.name === "Careers")
                                            action = "click_career_block";
                                        ga.event({
                                            action,
                                            params: {
                                ...
                                >
                                    ...
                                    <span>
                                        {mapAppCategory[category.id].length ??
                                            0}
                                    </span>
                                </div>
                            );
                    ...
                    <div className="slider-right" id="slider-right">
                        <div
                            className="right-icon align-center"
                            onClick={() => scroll("left")}
                        >
                            <ArrowLeft width={20} height={20} />
                        </div>
                    ...
                    {mapAppCategory[categorySelected]
                        ...
                        .map((app, index) => {
                            return (
                                ...
                                >
                                    <div className="font-14 app-name">
                                        {app.appName.toUpperCase()}
                                    </div>
                                    <div className="font-14 dot">&middot;</div>
                                    <div className="font-14 total-questions">
                                        {app.totalQuestion}
                                    </div>
