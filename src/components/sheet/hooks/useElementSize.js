...
var useElementSize = function useElementSize(_ref) {
  ...
  var handleResize = function handleResize(entries) {
    ...
    if (
      ((_entries$0$borderBoxS = entries[0].borderBoxSize) == null
        ? void 0
        : _entries$0$borderBoxS.length) > 0
    ) {
      var _entries$0$borderBoxS2;
      setSize(
        (_entries$0$borderBoxS2 = entries[0].borderBoxSize[0]) == null
          ? void 0
          : _entries$0$borderBoxS2.blockSize
      );
    } else {
