...
var Content = /*#__PURE__*/ forwardRef(function (props, ref) {
  ...
  var title = props.title,
    ...
    defaultSnapPoint =
      _props$defaultSnapPoi === void 0 ? 0 : _props$defaultSnapPoi,
    onSnap = props.onSnap;
  ...
  var getDuration = function getDuration(_ref) {
    ...
    return !isVisible || !points || currentPoint === points.length - 1
      ? ANIMATION_DURATION
      : undefined;
  };
  var animationConfig = _objectSpread(
    _objectSpread({}, config.stiff),
    {},
    {
  ...
  var _useSpring = useSpring(function () {
      return {
        transformAmount:
          sheetHeight || (typeof window !== "undefined" && window.innerHeight),
        movingAmount: 0,
  ...
  var cls = classNames(
    prefixCls,
    ((_classNames = {}),
    (_classNames[prefixCls + "-hug-content"] = autoHeight),
    _classNames)
  );
  ...
  var transform = to(
    [transformAmount, movingAmount],
    function (amount, moving) {
  ...
  var handlerEl = /*#__PURE__*/ React.createElement(
    "div",
    _extends(
      {
        ref: handlerRef,
