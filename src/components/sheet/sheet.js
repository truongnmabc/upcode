...
var Sheet = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  useImperativeHandle(contentRef, function () {
    ...
    return (_sheetRef$current = sheetRef.current) == null
      ? void 0
      : _sheetRef$current.sheet;
  });
  useImperativeHandle(ref, function () {
    var _sheetRef$current2, _sheetRef$current3;
    return {
      sheet:
        (_sheetRef$current2 = sheetRef.current) == null
          ? void 0
          : _sheetRef$current2.sheet,
      snapTo:
        (_sheetRef$current3 = sheetRef.current) == null
          ? void 0
          : _sheetRef$current3.snapTo,
    };
  });
  useEffect(
    function () {
