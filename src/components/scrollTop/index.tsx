...
const ScrollToTopArrow: React.FC<ScrollToTopArrowProps> = ({ scrollRef }) => {
  ...
  return (
    <div
      className="fixed z-10 bottom-8 right-8 flex items-center justify-center w-12 h-12 rounded-full bg-white text-center shadow-md cursor-pointer hover:h-14 transition-all duration-200 ease-in-out sm:bottom-12"
      onClick={scrollToTop}
    >
