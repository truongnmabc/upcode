...
const ListTestsDrawer = ({
  ...
  useEffect(() => {
    const handleGetDataTopic = async () => {
      const data = await db.tests.toArray();
      console.log("🚀 ~ handleGetDataTopic ~ data:", data);
    ...
    <div className="p-3">
      ...
      >
        <div className=" font-poppins text-lg capitalize font-semibold">
          {appInfo.appShortName} Branch Test
        </div>
...
export default React.memo(ListTestsDrawer);
