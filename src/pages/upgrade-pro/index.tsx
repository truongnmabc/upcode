...
import { ONETIME, SUBSCRIPTION, getConfigProV2 } from "../../config/config_paypal";
...
const StoreReviews = dynamic(() => import("../../components/store-review/StoreReviews"), {
    ssr: false,
...
const GetProPage = ({ appInfo }: { appInfo: IAppInfo }) => {
    ...
    return (
        <>
            ...
            <V4LoginDialog appInfo={appInfo} open={openLoginDialog} setOpen={setOpenLoginDialog} />
        </>
    );
};
export const getServerSideProps = async (context) => {
    ...
    if (!appInfo) {
        ...
        context.res.writeHead(302, { Location: Routes.LANDING_PAGE_SCREEN + appInfo.appNameId }).end();
        return { props: {} };
    }
